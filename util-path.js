...
// Normalize an uri
// normalize("path/to/a") ==> "path/to/a.js"                                                                 //处理后缀  添加后缀名
...
function id2Uri(id, refUri) {                                                              //将id装换为完整的url地址
  if (!id) return ""
...
var doc = document
var loc = location
var cwd = dirname(loc.href)                                                                      //cwd指向浏览器地址栏地址
...
var loaderDir = dirname(getScriptAbsoluteSrc(loaderScript)) || cwd                            //获取src属性值

function getScriptAbsoluteSrc(node) {                                                        //ie6 7 bug 修复
...
// Get/set current working directory                                                             //设置和获取当前工作路径
